// 激活对应模块的菜单
$("#robotFunctionSidebar").addClass("active")
...
$(document).ready(function () {
    $("#confirmUpdateBtn").click(function () {
        ...
        updateData["robot_function_id"] = $("#updateForm").attr("robot-function-id")
