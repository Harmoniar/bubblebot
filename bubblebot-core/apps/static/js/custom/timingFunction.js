...
$("#timingFunctionSidebar").addClass("active")
...
function renderDataToTable(queriedData) {
    ...
    $.each(queriedData.current_page_data, function (index, data) {
        ...
        let rowHtml = "<tr data-id='{timing_function_id}'>\
        ...
        <td style='width: 120px;' title='{timing_function_url}'>{timing_function_url}</td>\
        <td style='width: 120px;'>{timing_function_class}</td>\
        <td style='width: 120px;'>{default_timing_cron}</td>\
        ...
        <td style='width: 145px;'>{action}</td>\
            ...
            .format({
                ...
                timing_function_url: data.timing_function_url,
                timing_function_class: data.timing_function_class,
                global_function_status: data.global_function_status,
                default_timing_cron: data.default_timing_cron,
...
$(document).ready(function () {
    $("#confirmUpdateBtn").click(function () {
        ...
        updateData["original_timing_function_id"] = $("#updateForm").attr("original-timing-function-id")
